        ...
        <el-scrollbar class="scrollbar">
            ...
            <el-search-table-pagination
                ...
                <template slot-scope="scope" slot="preview-source">
                    <span v-if="scope.row.source=='B'" class="ocolorp">申诉中</span>
                    <span v-if="scope.row.source=='A'" class="color">申诉成功</span>
                    <span v-if="scope.row.source=='C'" class="color999">申诉驳回</span>
                </template>
                <template slot-scope="scope" slot="preview-handle">
                    <div class="table-span">
                        <a @click="infoFn(scope.row,'申请审核')" v-if="scope.row.source=='B'">审核</a>
                        <a @click="infoFn(scope.row,'申请查看')" v-else>查看</a>
                    </div>
                </template>
            </el-search-table-pagination>
        </el-scrollbar>
    ...
    data(){
        return{
            ...
            table_columns:[
                ...
                { prop: 'name', label: '无效原因',align:'center',minWidth:25},
                { prop: 'sex', label: '信贷经理编号',align:'center',minWidth:8},
            ...
            table_data:[
                ...
                {code:"000001",name:"手机号为空",phone:"公积金贷款",sex:"0234234234",city:"上海",source:"B",order:"23.23元",time:"2019-12-12 12:12:12",config:"小驴审核专员B"},
                {code:"000001",name:"手机号为空",phone:"公积金贷款",sex:"0234234234",city:"成都",source:"C",order:"23.23元",time:"2019-12-12 12:12:12",config:"小驴审核专员C"},
                {code:"000001",name:"手机号为空",phone:"房屋抵押",sex:"0234234234",city:"成都",source:"B",order:"23.23元",time:"2019-12-12 12:12:12",config:"小驴审核专员D"},
            ],
            infoData:{
                visible:false,
                id:"",
