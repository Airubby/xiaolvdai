    ...
    data(){
        return{
            ...
            table_columns:[
                ...
                { prop: 'order', label: '竞价积分',align:'center',minWidth:8},
                { prop: 'config', label: '审核人员',align:'center',minWidth:8},
                { prop: 'handle', label: '操作',align:'center',slotName:'preview-handle',width:100},
            ],
            table_data:[
                {code:"000001",name:"信用贷款",phone:"公积金贷款",sex:"0234234234",city:"成都",source:"A",order:"34",time:"2019-12-12 12:12:12",config:"小驴审核专员A"},
                {code:"000001",name:"信用贷款",phone:"公积金贷款",sex:"0234234234",city:"上海",source:"B",order:"34",time:"2019-12-12 12:12:12",config:"小驴审核专员B"},
                {code:"000001",name:"信用贷款",phone:"公积金贷款",sex:"0234234234",city:"成都",source:"C",order:"34",time:"2019-12-12 12:12:12",config:"小驴审核专员C"},
                {code:"000001",name:"抵押贷款",phone:"房屋抵押",sex:"0234234234",city:"成都",source:"D",order:"34",time:"2019-12-12 12:12:12",config:"小驴审核专员D"},
            ],
            infoData:{
                visible:false,
                id:"",
