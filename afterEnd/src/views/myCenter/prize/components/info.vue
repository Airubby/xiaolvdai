<template>
    <el-dialog :title="dialogInfo.title" :visible.sync="dialogInfo.visible" width="600px" v-dialogDrag :close-on-click-modal="false">
                    ...
                    <el-row :gutter="25">
                        ...
                        <el-col :span="10">
                            <el-form-item label="所需积分:">
                                <el-input v-model="initParams.education"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="14">
